...
class PrepareVectorDB:
    ...
    def run(self):
        ...
        if not os.path.exists(here(self.vectordb_dir)):
            ...
            ## Create a Single List as required ahead on text_splitter
...
if __name__ == "__main__":
    ...
    # Configs to run for stories document
    ...
    ## Test that Chroma Vector DB is created or Not
    vectordb = Chroma(
        collection_name = collection_name,
    ...
    print('Number of Vectors in Vector DB: \n')
